...
At-least-once: сообщение доставлено минимум раз, возможны дубли. Нужна идемпотентность обработчика.

Exactly-once: ровно один раз. Сложно: требует транзакций (Kafka transactions, idempotent producer).
